 ...
 <ul class="app-nav">
  <div class="dropdown">
    ...
    <div class="dropdown">
      <a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu">
        ...
        <div class="app-notification dropdown-menu dropdown-menu-right">
          ...
          <div class="app-notification__content">
            <div><li class="app-notification__item" onclick="cargar_contenido('Contenido_principal','../view/prolife/view_change_password.php')">
        ...
        <div class="app-notification__content">
          <div><li class="app-notification__item" onclick="cargar_contenido('Contenido_principal','../view/prolife/view_show_profile.php')">
            <span class="app-notification__icon">
              <span class="fa-stack fa-lg">
      ...
      <?php } ?>
      <div class="app-notification__content">
        <div><li class="app-notification__item" onclick="distroysession()">
          <span class="app-notification__icon">
            <span class="fa-stack fa-lg">
