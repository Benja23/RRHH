...
<div class="modal-footer">
  ...
  <button class="btn btn-primary" id="btn-register" onclick="Registrar_Pagos_mensuales(this)"><i id="icono"  class="fa fa-check-circle-o" aria-hidden="true"></i>Pagar</button>
</div>
...
<div class="modal fade" id="modapagosimprimir" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button class="btn btn-primary" id="btn-register"  onclick="ImprimiReportePago(this)">
