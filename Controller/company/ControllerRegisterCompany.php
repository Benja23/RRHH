 ...
 if (isset($_SESSION['username'])) {
     setcookie("activo", 1, time() + 3600);
        ...
        if (count($currenCompany ) > 0) {
            ...
            $result = $companny->Update_company($idCompany, $name, $description, $address, $phone, $currency, $email, $logo, $flag, $ruc, $branch);
            
        }else{
           $result = $companny->Register_company($id, $name, $description, $address, $phone, $currency, $email, $logo, $flag, $ruc, $branch, $status);
        }
